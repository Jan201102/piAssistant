...
class Mastermodel(Imastermodel):
    ...
    def __init__(self):
        ...
        self.encoder = tf.keras.models.load_model(path.join(self.templateFolder, "mastermode_encoder_LSTM_64_V0_3.h5"))
        self.decoder = tf.keras.models.load_model(path.join(self.templateFolder, "mastermodel_decoder_LSTM_64_V0_3.h5"),
    ...
    def run_mastermodel(self, text, len_seq=50):
        ...
        y = self.encoder.predict(x, verbose=False)
        ...
        for i in range(len_seq):
            out = self.decoder.predict(
                {"encoderStates": sequences, "decoderStateH": h, "decoderStateC": c, "decoderIn": decoder_seq},
                verbose=False)
